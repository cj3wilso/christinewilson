				...
				<div class="main row gx-0 spacing-t">
					<div class="left-col col-md-5 col-lg-4 col-print-4 spacing-l">
						...
						<section class="top-5">
							...
							<div id="restapis" class="gauge-container one"><div class="language">REST APIs</div></div>
...
<div class="signature-resume d-block d-sm-none"><?php echo wp_get_attachment_image( 5176, 'medium', false, array( "class" => "img-fluid" ) ); ?></div>
<script>
	const gaugeOptions = {
          max: 10,
          dialStartAngle: -1,
